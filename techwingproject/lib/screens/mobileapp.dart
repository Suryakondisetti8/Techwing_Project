        ...
        body: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Container(
                  child: Image.asset("images/MADimage.jpg"),
...
class MADSyllabus extends StatelessWidget {
  const MADSyllabus({super.key});
      ...
      home: Scaffold(
        ...
        body:SingleChildScrollView(
          child: Column(
            ...
            children: [
              Container(child:Image.asset("images/MobileApp Page-1.jpeg"),),
              Container(child:Image.asset("images/MobileApp Page-2.jpeg"),),
              Container(child:Image.asset("images/MobileApp Page-3.jpeg"),),
              Container(child:Image.asset("images/MobileApp Page-4.jpeg"),),
            ],
          ),
        )
      ),
